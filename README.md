...
This tool was made because of disatisfaction with existing cli tools. They either require too long commands/flags, require a remote agent when wanting to interact with the local clipboard, or simply do not work at all over ssh.
...
cb "literal string"            # copy a string (as long as it is not an existing filepath)
